                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql =  "SELECT * FROM projects WHERE cat_id = 3 AND delete_flag = 0 ORDER BY date_created DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><a title="View Project Details" href="project_phase.php?id=<?=base64_encode($row['project_id'])?>&page=<?=base64_encode('normalServices.php')?>&t=<?=base64_encode($row['project_name'])?>"><?= $row['project_name']; ?></a></td>
