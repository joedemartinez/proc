                          ...
                          <td>
                            ...
                            if($password['user_type'] == 'admin'):
                              if($_SESSION['user'] != $row['emp_id']): ?>
                                <button class='btn btn-success btn-sm btn-flat reset' data-id='<?= $row['emp_id']?>'><i class='fa fa-refresh'></i> Reset Password</button>
                                <button class='btn btn-warning btn-sm btn-flat deactivate' data-id='<?= $row['emp_id']?>'><i class='fa fa-toggle-off'></i> Deactivate</button>
